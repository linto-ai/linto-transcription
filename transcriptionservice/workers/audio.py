...
def transcoding(input_file_path: str, output_sr: int = 16000, output_channels: int = 1, cleanup: bool = True) -> str:
...
def vadCutIndexes(audio, sample_rate, chunk_length: float = 0.03, mode: int = 1, min_silence_frame: int = 10):
